  ...
  return (
    ...
    <PopoverTrigger onClick={() => setPopoverOpen(!popoverOpen)}> 
        <div className="flex items-center gap-4">
            ...
            <div className='flex flex-col text-left'>
              ...
              <div>
                <span className="text-sm font-medium text-neutral-500">Unidade 2 - Consultorio 1</span>
              </div> 
            </div> 
    ...
    <PopoverContent className='w-auto p-0'> 
      ...
      <div className='flex gap-3 justify-end p-4'>
          <Button 
          size={'sm'}
          className='bg-secondary text-primary border hover:bg-neutral-200' onClick={() => setPopoverOpen(!popoverOpen)}>Cancelar</Button> 
