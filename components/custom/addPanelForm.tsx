...
import { editPanelRequestData, editPanelRequestDataResolver } from '@/core/models/validationSchemas/panelRequestData'
...
export const AddPanelForm: React.FC = () => {
  const { panelLayouts, passwordCallConfigurations, addPanel,serviceActive } = usePanelAndTotem();  
