...
export const RemoveServiceForm: React.FC<{id:string, description:string}> = (data) => {
    ...
    <AlertDialogContent className='bg-white'>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
            Deseja realmente apagar a classificação <span className='text-primary'>{data.description}</span>?
        </AlertDialogDescription>
      </AlertDialogHeader> 
        <div className="flex justify-between">
          ...
          <AlertDialogAction asChild>
              <Button onClick={(e) => handleRemoveService(panelId, data.id)}>Confirmar</Button>
          </AlertDialogAction>
        </div> 
    </AlertDialogContent>
  </AlertDialog> 
