...
import { ClassificationRequestData, classificationRequestDataResolver } from '@/core/models/validationSchemas/classificationRequestData'
      ...
      <DialogContent className="sm:max-w-[425px] bg-white" >
        ...
        <div className="grid gap-4 py-4">
          <div className="grid items-center gap-4">
             <form onSubmit={handleSubmit(onClassificationSubmit)} className="space-y-8">
