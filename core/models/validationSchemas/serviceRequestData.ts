...
export const ServiceRequestDataResolver = z.object({
  ...
  active: z.string(),
  acronym: z.string().min(1, { message: 'A sigla deve conter ao menos 1 caractere' }),
...
export type EditServiceRequestData = z.infer<typeof EditServiceRequestDataResolver>
